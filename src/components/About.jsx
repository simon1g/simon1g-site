...
const SoundCloudIcon = ({ size = 24 }) => (
    <svg width={size} height={size} viewBox="0 0 20 20" fill="currentColor">
        <path d="M6.5857 6.748c0-10.0284 .096-10.2195 .2889-10.2809 3.2124-.7596 6.4578 1.4816 6.7526 4.8578 3.1404-1.3261 5.871 2.67 3.4372 5.0697-.6167.608-1.3563.9121-2.2189.9121l-8.093-.0089c-.1069-.0357-.1669-.1466-.1669-.2308l0-.0001zm-2.1769-.2951c0 .7249 1.3773 .7338 1.3773 0l0-9.6481c0-.9131-1.3773-.9092-1.3773 0l0 9.6481zm-2.1389 0c0 .7081 1.3763 .7358 1.3763 0l0-5.6867c0-.9131-1.3763-.9091-1.3763 0l0 5.6867zm-2.1309-.2951c0 .7289 1.3683 .7408 1.3683 0l0-6.2304c0-.8824-1.3683-.8933-1.3683 0l0 6.2304zm-2.1389-1.1429c0 .8507 1.3673 1.0656 1.3673 0l0-2.673c0-.9052-1.3673-.8973-1.3673 0l0 2.673z" transform="translate(-4,7.5)" />
    </svg>
);
